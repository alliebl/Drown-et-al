...
General linear model of HL vs Bite Force (P = 2.2e-16)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of HH vs Bite Force (P = 2.2e-16)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of CH vs Bite Force (P = 1.29e-15)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of LJL vs Bite Force (P = 5.428e-15)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of HW vs Bite Force (P = 1.141e-15)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of CW vs Bite Force (P = 6.719e-15)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of JW vs Bite Force (P= 1.664e-13)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. maximum bite force (p=2.63e-16) (R^2 = 0.9391)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. peak velocity in cm (P = 0.003983, R^2 = 0.2678)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. peak velocity/body lengths (P = 2.193e-09, R^2 = 0.7719)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. Bird color space color change PC1 (p = 0.161, R^2 = 0.0418)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. Snake color space color change PC1 (P = 0.2600, R^2 = 0.01305)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
General linear model of SVL vs. Snake color space color change PC2 (P = 0.1119, R^2 = 0.06451)
```{r}
library(ggplot2)
ggplot(GGchameleon2)
...
ggplot(Behavior.Proportions.noA03, aes(x= bite.resid, y= agg.m18.pred, color= Habitat)) + geom_point(y=prop.agg) + geom_smooth(method = "glm") + #make plot as normal with original data; geom_point gives raw data points (add "+ geom_point()" to include raw data); geom_smooth uses predicted values to generate smooth line
  ...
  scale_y_continuous(limits=c(-0.3,1),breaks=c(-0.25,0.0,0.25,0.5,0.75,1.0),expand=c(0,0)) +
  theme_bw()

#ggsave("RelativeBiteForcevsPropAggression_Fit.pdf",useDingbats=FALSE)
...
ggplot(Behavior.Proportions.noA03, aes(x= SVL, y= agg.m18.pred, color= Habitat)) + geom_point(y=prop.agg) + geom_smooth(method = "glm") + #make plot as normal with original data; geom_point gives raw data points(add "+ geom_point()" to include raw data); geom_smooth uses predicted values to generate smooth line
  xlab("Snout-vent Length (cm)") +
...
ggplot(Behavior.Proportions.noA03, aes(x= normalized.peak.velocity, y= flee.m19.pred, color= Habitat)) + geom_point(y=prop.flee) + geom_smooth(method = "glm") + #make plot as normal with original data; geom_point gives raw data points(add "+ geom_point()" to include raw data); geom_smooth uses predicted values to generate smooth line
...
ggplot(Behavior.Proportions.noA03, aes(x= BirdPC1, y= cryp.m18.pred, color= Habitat)) + geom_point(y=prop.crypsis) + geom_smooth(method = "glm")  + #make plot as normal with original data; geom_point gives raw data points(add "+ geom_point()" to include raw data); geom_smooth uses predicted values to generate smooth line
...
ggplot(Behavior.Proportions.noA03, aes(x= normalized.peak.velocity, y= ring.m18.pred, color= Habitat)) + geom_point(y=prop.ring) + geom_smooth(method = "glm")  + #make plot as normal with original data; geom_point gives raw data points(add "+ geom_point()" to include raw data); geom_smooth uses predicted values to generate smooth line
  xlab("Normalized Peak Velocity\n(body lengths s-1)") +
  scale_x_continuous(limits=c(0,5),breaks=c(0,1,2,3,4,50),expand=c(0,0))+
